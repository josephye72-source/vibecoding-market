...
The fallback is only a lightweight collection surface. It must not become a community product, comments system, submission pipeline, ranking board, or account system.

## Feedback Template

Ask users to answer these four questions:

1. Which project is most interesting to you?
2. Would you be willing to reproduce one of the projects with Codex?
3. Where did you get stuck, confused, or unsure what to click or read next?
4. What remix idea would you try if you changed the project?
